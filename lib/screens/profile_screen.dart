...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // STREAM: Escucha cambios constantes en tu perfil (avatar, banner, etc)
              ...
              child: Column(
                children: [
                      ...
                      Positioned(
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            key: ValueKey(userData['avatar_url']), // Forzamos refresco de imagen
                          ),
                        ),
                      ),
                    ],
                  ...
                  Row(
                    ...
                    children: [
                      Text(userData['display_name'] ?? userData['username'] ?? "Artista", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
                      if (isVerified) ...[
                  ...
                  Padding(
                    ...
                    child: Text(userData['bio'] ?? "Sin biografía todavía. ✨", textAlign: TextAlign.center),
                  ),
                  
                  // CONTADORES REACTIVOS (Streams de seguidores)
